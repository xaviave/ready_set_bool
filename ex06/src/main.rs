...
mod tests {
	...
	fn eval_distributivity_2() {
		assert_eq!(conjunctive_normal_form("AB|C&!"), "A!C!|B!C!|&");
	}
	...
	#[test]
	fn eval_and_or_and_1() {
		assert_eq!(conjunctive_normal_form("ABCD&|&"), "ACB|DB|&&");
	}

	#[test]
	fn eval_or_or_and() {
		assert_eq!(conjunctive_normal_form("AB|C|D&"), "ABC||D&");
	}
	// PARSING TESTS
	#[test]
	#[should_panic]
