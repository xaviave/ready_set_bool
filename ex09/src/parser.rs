...
use crate::binary_tree::{
    and_node, apply_distributivity, equal_node, id_node, imply_node, negation_node, or_node,
    xor_node, BinaryTree, BtNode,
};
...
impl ParserA {
    ...
    pub fn resolve(&self, data: Vec<Vec<i32>>) -> Vec<i32> {
